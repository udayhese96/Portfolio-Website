          ...
          <div className="md:w-1/2 animate-fade-in">
            ...
            <div className="flex items-center space-x-6 mb-8">
              ...
              <div className="flex items-center gap-4">
                <a href={hero.githubLink} target="_blank" rel="noopener noreferrer" className="text-portfolio-dark hover:text-portfolio-blue">
                ...
                <a href={hero.linkedinLink} target="_blank" rel="noopener noreferrer" className="text-portfolio-dark hover:text-portfolio-blue">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
