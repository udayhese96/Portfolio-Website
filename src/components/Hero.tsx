        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          <div className="md:w-1/2 animate-fade-in">
            ...
            <p className="text-lg text-portfolio-gray mb-8 max-w-lg">
              Hi, I'm a passionate student developer. I enjoy building web applications and solving complex problems with code.
            </p>
            ...
            <div className="flex items-center space-x-6 mb-8">
              ...
              <div className="flex items-center gap-4">
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-portfolio-dark hover:text-portfolio-blue">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-portfolio-dark hover:text-portfolio-blue">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
